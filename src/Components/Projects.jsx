...
import taskager from '../assets/project6.png'
        ...
        <div className='Projects' id='Projects'>
            ...
            <div className="grid">
                <div ref={projectRightRef} className="box">
                    <div className="text">
                        <div className="button"><p>2024-06</p></div>
                        <p className="heading">Taskager</p>
                        <p className='par'>This is one of my biggest Projects . The Stack is React and sass frontend , NestJS backend and i used mongoDB database . But because of deployment problems you can see it only as github repository.</p>
                        <div onClick={() => {
                            window.location.href = 'https://github.com/elizbaryananush/TaskSystem2'
